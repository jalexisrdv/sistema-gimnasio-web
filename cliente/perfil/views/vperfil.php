<div class="container principal-content">
    <div class="row justify-content-center align-items-center">
        <div class="col-12 ">
            <center>
                <!-- ---------------------IMAGEN----------------- -->
                <a href="#aboutModal" data-toggle="modal" data-target="#myModal"><img src="<?php echo $clientes->getUrlFoto(); ?>" name="aboutme" width="140" height="140" class=" rounded-circle img-circle"></a>
                <h3><?php echo $clientes->getNombre();
                echo " ".$clientes->getApellidos(); ?></h3>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                <?php echo $clientes->getApellidos(); ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                <?php echo $clientes->getFechaNacimiento(); ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                <?php echo $clientes->getFechaIngreso(); ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                <?php echo $clientes->getNivelCliente(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                <?php echo $clientes->getEstatura(); ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">PESO INICIAL:</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                <?php echo $clientes->getPesoInicial(); ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">PESO PROGRESO:</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                <?php echo $clientes->getPesoProgreso(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
