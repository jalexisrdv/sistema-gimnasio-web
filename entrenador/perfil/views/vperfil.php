<div class="container principal-content">
    <div class="row justify-content-center align-items-center">
        <div class="col-12 ">
            <center>
                <!-- ---------------------IMAGEN----------------- -->
                <a href="#aboutModal" data-toggle="modal" data-target="#myModal"><img src="<?php echo $entrenadores->getUrlFoto(); ?>" name="aboutme" width="140" height="140" class=" rounded-circle img-circle"></a>
                <h3><?php echo $entrenadores->getNombre();
                    echo " " . $entrenadores->getApellidos(); ?></h3>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <?php echo $entrenadores->getNombre(); ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <?php echo $entrenadores->getApellidos(); ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <?php echo $entrenadores->getFechaNacimiento(); ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <?php echo $entrenadores->getFechaIngreso(); ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <?php echo $entrenadores->getNivelEntrenador(); ?>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <?php echo $entrenadores->getHorario(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col">
            <center>
                ...
                <div class="human-body">
                    <svg data-position='Cabeza' id='head' class='head' xmlns='http://www.w3.org/2000/svg' width='56.594' height='95.031' viewBox='0 0 56.594 95.031'>
                    ...
                    <svg data-position='Hombro-Izquierdo' id='left-shoulder' class='left-shoulder' xmlns='http://www.w3.org/2000/svg' width='109.532' height='46.594' viewBox='0 0 109.532 46.594'>
                    ...
                    <svg data-position='Hombro-Derecho' id='right-shoulder' class='right-shoulder' xmlns='http://www.w3.org/2000/svg' width='109.532' height='46.594' viewBox='0 0 109.532 46.594'>
                    ...
                    <svg data-position='Brazo-Izquierdo' id='left-arm' class='left-arm' xmlns='http://www.w3.org/2000/svg' width='156.344' height='119.25' viewBox='0 0 156.344 119.25'>
                    ...
                    <svg data-position='Brazo-Derecho' id='right-arm' class='right-arm' xmlns='http://www.w3.org/2000/svg' width='156.344' height='119.25' viewBox='0 0 156.344 119.25'>
                    ...
                    <svg data-position='Pecho' id='chest' class='chest' xmlns='http://www.w3.org/2000/svg' width='86.594' height='45.063' viewBox='0 0 86.594 45.063'>
                    ...
                    <svg data-position='Estomago' id='stomach' class='stomach' xmlns='http://www.w3.org/2000/svg' width='75.25' height='107.594' viewBox='0 0 75.25 107.594'>
                    ...
                    <svg data-position='Pierna-Izquierda' id='left-leg' class='left-leg' xmlns='http://www.w3.org/2000/svg' width='93.626' height='250.625' viewBox='0 0 93.626 250.625'>
                    ...
                    <svg data-position='Pierna-Derecha' id='right-leg' class='right-leg' xmlns='http://www.w3.org/2000/svg' width='80' height='250.625' viewBox='0 0 80 250.625'>
                    ...
                    <svg data-position='Mano-Izquierda' id='left-hand' class='left-hand' xmlns='http://www.w3.org/2000/svg' width='90' height='38.938' viewBox='0 0 90 38.938'>
                    ...
                    <svg data-position='Mano-Derecha' id='right-hand' class='right-hand' xmlns='http://www.w3.org/2000/svg' width='90' height='38.938' viewBox='0 0 90 38.938'>
                    ...
                    <svg data-position='Pie-Izquierdo' id='left-foot' class='left-foot' xmlns='http://www.w3.org/2000/svg' width='30' height='30' viewBox='0 0 30 30'>
                    ...
                    <svg data-position='Pie-Derecho' id='right-foot' class='right-foot' xmlns='http://www.w3.org/2000/svg' width='90' height='38.938' viewBox='0 0 90 38.938'>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <?php echo $entrenadores->getEstatura(); ?>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
